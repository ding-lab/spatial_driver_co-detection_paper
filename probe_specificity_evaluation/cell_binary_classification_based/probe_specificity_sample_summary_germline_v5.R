...
for (i in 1:number_of_variants) {
    ...
    if ((sum(data["Normal_cell",]) !=0) & (sum(data["Cancer_cell",]) !=0)) {
        ...
        statistics_table_results[i, "true.positive.rate.restricted..proportion.test.value.1..Proportion.of.cancer.cells.with.at.least.one.variant.allele.out.of.total.number.of.cancer.cells.with.variant.site.probe"] <- variant_prop_test$estimate[1][[1]] # true.positive.rate if the sample actually has the mutation
        statistics_table_results[i, "false.positive.rate.restricted..proportion.test.value.2..Proportion.of.normal.cells.with.at.least.one.variant.allele.out.of.total.number.of.normal.cells.with.variant.site.probe"] <- variant_prop_test$estimate[2][[1]] # false.positive.rate if the sample actually has the mutation.
        statistics_table_results[i, "false.negative.rate.restricted..Proportion.of.cancer.cells.with.only.reference.allele.out.of.total.number.cancer.cells.with.variant.site.probe"] <- data["Cancer_cell","WT"] / (data["Cancer_cell","ALT"] + data["Cancer_cell","WT"]) #false.negative.rate if the sample actually has the mutation
        statistics_table_results[i, "true.negative.rate.restricted..Proportion.of.normal.cells.with.only.reference.allele.out.of.total.number.normal.cells.with.variant.site.probe"] <- data["Normal_cell","WT"] / (data["Normal_cell","ALT"] + data["Normal_cell","WT"]) #true.negative.rate if the sample actually has the mutation
        statistics_table_results[i, "Proportion.of.cancer.cells.with.at.least.one.variant.allele.out.of.total.number.of.cancer.cells.with.and.without.variant.site.coverage..true.positive.rate.open"] <-  data["Cancer_cell","ALT"]/statistics_table_results[i, "total.number.of.cancer.cells.in.sample.IDs.with.variant"]#true.positive.rate if the sample actually has the mutation
        statistics_table_results[i, "Proportion.of.normal.cells.with.at.least.one.variant.allele.out.of.total.number.of.normal.cells.with.and.without.variant.site.coverage..false.positive.rate.open"] <-  data["Normal_cell","ALT"]/statistics_table_results[i, "total.number.of.cells.in.all.samples.after.low.quality.removed"]#false.positive.rate if the sample actually has the mutation
