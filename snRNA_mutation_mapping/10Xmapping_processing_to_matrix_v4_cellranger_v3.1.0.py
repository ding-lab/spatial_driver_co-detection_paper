...
for line in sample_file:
    if "Chromosome" in line:
        ...
        variant = "chr" + chrom + "_" + start + "_" + ref_allele + "_" + var_allele
...
output_variant_file_name=current_working_dir+"/"+sample+"/"+basename+".mutant_variant_matrix.tsv"
...
output_mutant_gene_file_name=current_working_dir+"/"+sample+"/"+basename+".mutation_matrix.tsv"
...
output_variant_gene_file_name=current_working_dir+"/"+sample+"/"+basename+".variant_gene_matrix.tsv"
...
output_reference_gene_file_name=current_working_dir+"/"+sample+"/"+basename+".reference_gene_matrix.tsv"

output_variant_allele_count_file_name=current_working_dir+"/"+sample+"/"+basename+".variant_allele_count_matrix.tsv"
output_reference_allele_count_file_name=current_working_dir+"/"+sample+"/"+basename+".reference_allele_count_matrix.tsv"
